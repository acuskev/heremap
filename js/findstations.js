...
$.ajax({url: 'http://54.149.198.224:3000/api/getCelebs', dataType: 'JSONP',
...
function findStations(linkids, polyline) {
  const url = 'http://54.149.198.224:3000/api/getCelebs'; 
  ...
  // Create a search request object for the EVCHARGING_POI layer with the bounding box of the polyline
